...
- 默认优先使用 Qwen3.5-397B-A17B，其次 Qwen3-235B-A22B-Instruct-2507、Qwen3.5-122B-A10B。模型列在服务目录中不代表当前账户有可用额度；Qwen3.5 开启推理并预留 16000 token 总预算，普通 Instruct 模型保持 8000。推理内容不会进入日志、任务摘要或公开产物。
