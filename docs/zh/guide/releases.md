...
- 修复下载停滞判定改为 10s 并默认启用代理配置

### 📝 备注（Notes）
- 版本号读取自根目录 `.version` 并同步前后端配置
- 增强登录页 Logo 动态效果
- 调整时区选择选项
- 放行 mihomo delay 测速接口不计入全局限流

::: details 📋 构建信息
- **源提交**: [`b77b361`](https://github.com/msm9527/msm/commit/b77b3618bc30ba331f2ae57b4bdcb7cc8f8cb49e)
- **提交信息**: 优化更新检查频率与二进制选择逻辑（支持 x86-64-v3）,timeout_ms:100000,
- **提交作者**: doumao
- **提交时间**: 2026-01-11 12:58:15 +0800
:::
