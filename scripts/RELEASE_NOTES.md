...
- 请求统一发送到 `https://api-inference.modelscope.cn/v1/chat/completions`。默认优先使用 Qwen3.5-397B-A17B，其次 Qwen3.5-122B-A10B、Qwen3.5-35B-A3B；目录状态已于 2026-09-22 核对。模型列在服务目录中不代表当前账户有可用额度；Qwen3.5 开启推理并预留 16000 token 总预算。推理内容不会进入日志、任务摘要或公开产物。
