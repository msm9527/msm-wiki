...
### 🐛 修复（Fixed）
- Mihomo 订阅节点测速 404 回退健康检查
- Mihomo 订阅更新瞬时错误增加有限重试
- Mihomo 配置并发写入临时文件竞态修复
- Mihomo v1.19.28 节点显示不全修复
...
**问题修复**
- 修复 Mihomo TUN 配置回放、macOS 默认及 Fake-IP 值
...
- 性能提升：Mihomo 配置接口合并，API 调用减少 125 倍
- 性能优化：SSE 数据迁移至 Zustand，消除级联重渲染

**问题修复**
- 修复更新重启死循环，清理构建备份
- 修复更新下载跳过中转服务器，避免误装 Beta 版本
- 修复强制更新后无法安装重启及 Mihomo 版本显示异常
